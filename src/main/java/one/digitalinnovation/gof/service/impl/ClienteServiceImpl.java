 ...
 * ---------------------------------------------------------------------------------
 * Módulo..: Service -> impl->  ClienteserviceImpl.java
 * É o primeiro controle a ser acionado. Pois este é a interface de consumo. 
 *           
...
public class ClienteServiceImpl implements ClienteService {
	...
	public Cliente buscarPorId(Long id) {
		// Buscar Cliente por ID. Retorna na estrutura de Optional, poie este pode ou não exisitir.
